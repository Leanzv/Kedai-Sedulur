...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h5><i class="bi bi-plus-circle"></i> Tambah Menu Baru</h5>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" name="nama_menu" class="form-control @error('nama_menu') is-invalid @enderror" 
                               placeholder="Contoh: Cappuccino" value="{{ old('nama_menu') }}" required>
                        @error('nama_menu')
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="kategori" class="form-select @error('kategori') is-invalid @enderror" required>
                            ...
                            <option value="Squash" {{ old('kategori') == 'Squash' ? 'selected' : '' }}>Squash</option>
                        </select>
                        @error('kategori')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
